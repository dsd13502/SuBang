...
public class MainActivity extends ActionBarActivity implements
    ...
    private DoubleClickExitHelper mDoubleClickExit;//双击退出助手

    /**
     * Fragment managing the behaviors, interactions and presentation of the
     * navigation drawer.
     */
    private NavigationDrawerFragment mNavigationDrawerFragment;//左侧的导航栏

    @InjectView(android.R.id.tabhost)
    public MyFragmentTabHost mTabHost;//fragment标签组
